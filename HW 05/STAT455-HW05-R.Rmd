...
geometry: "left=0.5in,right=0.5in,top=1.5cm,bottom=2cm" 
...
paste("Pearson X-sq Statistic="
      , decimal(X2, dec), "on"
      , df, "degrees of freedom, with p-value of"
      , decimal(pval, dec)
      )
...
paste("Pearson X-sq Statistic="
      , decimal(X2.no14, dec), "on"
      , df.no14, "degrees of freedom, with p-value of"
